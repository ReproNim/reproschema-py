...
class TestCLI:
    ...
    def test_odc2reproschema_with_fixture(self, tmpdir):
        ...
        with tmpdir.as_cwd():
            ...
            assert os.path.isdir("test_instrument"), "Expected output directory 'test_instrument' does not exist"
            # Activity schema is created at activities/{name}/{name}_schema (no .jsonld extension)
            assert os.path.exists("test_instrument/activities/test_instrument/test_instrument_schema"), \
            ...
            assert os.path.exists("test_instrument/activities/test_instrument/items/item1"), \
                "Expected item at activities/test_instrument/items/item1"
            assert os.path.exists("test_instrument/activities/test_instrument/items/likert1_q1"), \
            ...
            assert os.path.exists("test_instrument/test_instrument/test_instrument_schema"), \
