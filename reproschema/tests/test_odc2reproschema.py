    ...
    def test_comprehensive_instrument_conversion(self, tmpdir):
        ...
        with tmpdir.as_cwd():
            ...
            expected_items = {
                ...
                "satisfaction_likert_overall": {
                    "input_type": "radio",
                    "has_choices": True,
                    "value_type": "xsd:integer",
                },
                "satisfaction_likert_wait_time": {
                    "input_type": "radio",
                    "has_choices": True,
                    "value_type": "xsd:integer",
                },
                ...
                "medical_history_year_diagnosed": {
                    "input_type": "number",
                    "value_type": "xsd:decimal",
                },
    ...
    def test_activity_schema_order_and_properties(self, tmpdir):
        ...
        with tmpdir.as_cwd():
            ...
            for prop in add_properties:
                ...
                assert (
                    "variableName" in prop
                ), "addProperty missing variableName"
                assert (
                    prop["isVis"] is True
                ), "addProperty isVis should be True"
            ...
            assert (
                variable_names == expected_var_names
            ), f"variableName mismatch: {variable_names}"
