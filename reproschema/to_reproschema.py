...
from .mappings import CSV_TO_REPROSCHEMA_MAP, VALUE_TYPE_MAP, INPUT_TYPE_MAP, ADDITIONAL_NOTES_LIST
...
class ReproSchemaConverter:
    ...
    def process_item(self, item: Dict[str, Any]) -> Dict[str, Any]:
        ...
        item_data = {
            ...
            'question': {'en': self.clean_html(item[self.csv_to_reproschema_map['question']])},
        ...
        if self.csv_to_reproschema_map['response_option'] in item:
            item_data['responseOptions']['choices'], item_data['responseOptions']['valueType'] = \
                self.process_response_options(item[self.csv_to_reproschema_map['response_option']], item[self.csv_to_reproschema_map['item_name']])
    ...
    def process_additional_notes(self, item: Dict[str, Any]) -> List[Dict[str, str]]:
        return [
